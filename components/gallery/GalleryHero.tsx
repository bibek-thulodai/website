...
export default function GalleryHero() {
  ...
  return (
    <section ref={ref} className="relative h-[70vh] overflow-hidden">
      ...
      <motion.div
        style={{ y }}
        className="absolute inset-0 z-0 bg-gradient-to-br from-[#01304f] via-[#014a59] to-[#003d31]"
      >
      ...
      <div className="container mx-auto px-4 h-full flex items-center relative z-10">
        <motion.div style={{ opacity }} className="max-w-4xl">
          ...
          >
            EXPLORE OUR VISUAL JOURNEY THROUGH EVENTS, PROGRAMS, AND IMPACT STORIES
          </motion.p>

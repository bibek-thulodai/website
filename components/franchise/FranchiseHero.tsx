...
export default function FranchiseHero() {
  ...
  const words = "FRANCHISE OPPORTUNITIES".split("")
        ...
        <motion.div style={{ opacity }} className="max-w-4xl">
          ...
          <div className="overflow-hidden mb-6">
            <motion.div initial={{ y: 100 }} animate={{ y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }}>
              <h1 className="text-5xl md:text-7xl font-bold text-white flex flex-wrap">
          ...
          >
            EXPAND YOUR IMPACT WITH OUR PROVEN FRANCHISE MODELS
          </motion.p>
          ...
          >
            <Button asChild className="bg-white text-accent hover:bg-white/90 hover:scale-105 transition-transform">
              <a href="#opportunity-talk">Opportunity Talk™</a>
            </Button>

...
export default function ProductsHero() {
  ...
  return (
    <section ref={ref} className="relative h-[70vh] overflow-hidden">
      ...
      <motion.div style={{ y }} className="absolute inset-0 z-0 bg-gradient-to-r from-secondary to-accent">
      ...
      <div className="container mx-auto px-4 h-full flex items-center relative z-10">
        <motion.div style={{ opacity }} className="max-w-4xl">
          ...
          >
            INNOVATIVE SOLUTIONS DESIGNED FOR EXCELLENCE
          </motion.p>
          ...
          >
            <Button asChild className="bg-white text-secondary hover:bg-white/90 hover:scale-105 transition-transform">
              <a href="#academic-calendar">Academic Calendar</a>
            </Button>
           
            <Button asChild className="bg-white text-secondary hover:bg-white/90 hover:scale-105 transition-transform">
              <a href="#csr-startups">CSR to Startups</a>
            </Button>
          </motion.div>
        </motion.div>
